...
T.truthy(map.pncHoverPortrait.width == 128
...
T.truthy(portraitTargetCount == 1,
...
T.truthy(portraitTargetCount == 2,
...
clock = 1300
T.truthy(PNC.MapHoverPortrait.Update(map, secondEntry, 130, 130)
