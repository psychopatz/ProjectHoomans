...
package.loaded["PNC/Integrations/PBrainZ/PNC_PBrainZ"] = PNC.PBrainZ
Events = { OnTick = {
...
T.load("ProjectHoomans", "client",
    "PNC/Integrations/PBrainZ/PNC_PBrainZ_Bridge.lua")
...
T.finish("pnc_pbrainz_bridge_setting_smoke")
