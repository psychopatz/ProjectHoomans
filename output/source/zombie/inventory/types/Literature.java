...
public final class Literature extends InventoryItem {
        ...
        if (character != null) {
            ...
            if (modData.rawget("literatureTitle") == null
                ...
                if (this.getStressChange() != 0.0F) {
                    ...
                    item.setLabel(Translator.getText("Tooltip_literature_Stress_Reduction", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                    if (value > 0.0F) {
                        item.setProgress(value, goodR, goodG, goodB, 1.0F);
                    } else {
                        item.setProgress(value * -1.0F, badR, badG, badB, 1.0F);
            ...
            if (this.getNumberOfPages() != -1) {
                ...
                item.setLabel(Translator.getText("Tooltip_literature_Number_of_Pages", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            ...
            if (this.getLvlSkillTrained() != -1) {
                ...
                item.setLabel(Translator.getText("Tooltip_Literature_XpMultiplier", new Object[]{label}), 1.0F, 1.0F, 0.8F, 1.0F);
            }
            ...
            if (this.getLearnedRecipes() != null && !illiterate) {
                for (String recipe : this.getLearnedRecipes()) {
                    ...
                    item.setLabel(Translator.getText("Tooltip_Literature_LearnedRecipes", new Object[]{label}), 1.0F, 1.0F, 0.8F, 1.0F);
                }

                LayoutItem item = layout.addItem();
                String label = Translator.getText("Tooltip_literature_NotBeenRead", new Object[0]);
                if (character.getKnownRecipes().containsAll(this.getLearnedRecipes())) {
                    label = Translator.getText("Tooltip_literature_HasBeenRead", new Object[0]);
                }
                ...
                if (character.getKnownRecipes().containsAll(this.getLearnedRecipes())) {
                    ...
                    if (knownProf > 0 || knownTrait > 0) {
                        item = layout.addItem();
                        item.setLabel(Translator.getText("Tooltip_literature_AlreadyKnown", new Object[0]), 0.0F, 1.0F, 0.8F, 1.0F);
                    }
                }
            } else if (this.getLearnedRecipes() != null && illiterate) {
                LayoutItem item = layout.addItem();
                String label = Translator.getText("ContextMenu_Illiterate", new Object[0]);
                item.setLabel(Translator.getText("Tooltip_Literature_LearnedRecipes", new Object[]{label}), 1.0F, 1.0F, 0.8F, 1.0F);
            }
            ...
            if (modData.rawget("learnedRecipe") != null && !illiterate) {
                ...
                item.setLabel(Translator.getText("Tooltip_Literature_LearnedRecipes", new Object[]{label}), 1.0F, 1.0F, 0.8F, 1.0F);
                item = layout.addItem();
                String label2 = Translator.getText("Tooltip_literature_NotBeenRead", new Object[0]);
                if (tooltipUI.getCharacter().getKnownRecipes().contains(recipe)) {
                    label2 = Translator.getText("Tooltip_literature_HasBeenRead", new Object[0]);
                }
                ...
                if (character.getKnownRecipes().contains(recipe)) {
                    ...
                    for (CharacterTrait characterTrait : characterTraits.getKnownTraits()) {
                        CharacterTraitDefinition trait = CharacterTraitDefinition.getCharacterTraitDefinition(characterTrait);
                        if (trait != null && trait.isGrantedRecipe(recipe)) {
                            knownTrait++;
                        }
            ...
            if (modData.rawget("literatureTitle") != null) {
                ...
                if (character.isLiteratureRead(title)) {
                    LayoutItem item = layout.addItem();
                    String label = Translator.getText("ContextMenu_RecentlyRead", new Object[0]);
                    if (this.hasTag(ItemTag.PICTURE)) {
                        label = Translator.getText("ContextMenu_RecentlySeen", new Object[0]);
                    }
    ...
    public void save(ByteBuffer output, boolean net) throws IOException {
        ...
        BitHeaderWrite bits = BitHeader.allocWrite(HeaderSize.Short, output);
    ...
    public void load(ByteBuffer input, int worldVersion) throws IOException {
        ...
        BitHeaderRead bits;
        if (worldVersion >= 226) {
            bits = BitHeader.allocRead(HeaderSize.Short, input);
        } else {
            bits = BitHeader.allocRead(HeaderSize.Byte, input);
        }
