...
public final class HandWeapon extends InventoryItem implements IUpdater {
    ...
    private WeaponReloadType weaponReloadType = WeaponReloadType.HANDGUN;
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, Layout layout) {
        ...
        if (this.hasSharpness()) {
            ...
            item.setLabel(Translator.getText("Tooltip_weapon_Sharpness", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        item.setLabel(Translator.getText(text, new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        float f = (float)this.getCondition() / this.getConditionMax();
        Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), f, g2Bgrad);
        item.setProgress(f, g2Bgrad.getR(), g2Bgrad.getG(), g2Bgrad.getB(), 1.0F);
        if (this.hasHeadCondition()) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_HeadCondition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.getMaxDamage() > 0.0F) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_Damage", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.hasTag(ItemTag.FISHING_ROD)) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_fishing_line_Condition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            ...
            if (lineConditionObj == null) {
                ...
                f = (float)((Double)lineConditionObj).doubleValue();
            }

            Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), f, g2Bgrad);
            item.setProgress(f, g2Bgrad.getR(), g2Bgrad.getG(), g2Bgrad.getB(), 1.0F);
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_fishing_line", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            Object lineObj = this.getModData().rawget("fishing_LineType");
            if (lineObj == null) {
                this.getModData().rawset("fishing_LineType", "FishingLine");
                item.setValue(Translator.getText(ScriptManager.instance.FindItem("Base.FishingLine").getDisplayName(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            } else if (ScriptManager.instance.FindItem("FishingLine") != null && ScriptManager.instance.FindItem((String)lineObj) != null) {
                item.setValue(Translator.getText(ScriptManager.instance.FindItem((String)lineObj).getDisplayName(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                item.setValue(Translator.getText("Tooltip_fishing_line", new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            }

            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_fishing_hook", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            Object hookObj = this.getModData().rawget("fishing_HookType");
            if (hookObj == null) {
                this.getModData().rawset("fishing_HookType", "FishingHook");
                item.setValue(Translator.getText(ScriptManager.instance.FindItem("FishingHook").getDisplayName(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            } else if (ScriptManager.instance.FindItem((String)hookObj) != null && ScriptManager.instance.FindItem("FishingHook") != null) {
                item.setValue(Translator.getText(ScriptManager.instance.FindItem((String)hookObj).getDisplayName(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                item.setValue(Translator.getText("Tooltip_fishing_hook", new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            }

            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_fishing_bait", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            Object lureObj = this.getModData().rawget("fishing_Lure");
            if (lureObj == null) {
                item.setValue(Translator.getText("UI_None", new Object[0]), 1.0F, 0.0F, 0.0F, 1.0F);
            } else if (ScriptManager.instance.FindItem((String)lureObj) != null && Translator.getText("UI_None", new Object[0]) != null) {
                item.setValue(Translator.getText(ScriptManager.instance.FindItem((String)lureObj).getDisplayName(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                item.setValue(Translator.getText("Tooltip_fishing_bait", new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
            }
        }

        if (this.isRanged()) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_Range", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.isTwoHandWeapon() && !this.isRequiresEquippedBothHands()) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_item_TwoHandWeapon", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
        }

        if (!StringUtils.isNullOrEmpty(this.getFireMode())) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_item_FireMode", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            item.setValue(Translator.getText("ContextMenu_FireMode_" + this.getFireMode(), new Object[0]), 1.0F, 1.0F, 1.0F, 1.0F);
        }

        if (this.cantAttackWithLowestEndurance) {
            item = layout.addItem();
            item.setLabel(
                Translator.getText("Tooltip_weapon_Unusable_at_max_exertion", new Object[0]),
        ...
        if (this.isJammed()) {
            item = layout.addItem();
            item.setLabel(
                Translator.getText("Tooltip_weapon_Jammed", new Object[0]),
                Core.getInstance().getBadHighlitedColor().getR(),
                Core.getInstance().getBadHighlitedColor().getG(),
                Core.getInstance().getBadHighlitedColor().getB(),
                1.0F
            ...
            item.setLabel(
                Translator.getText(text, new Object[0]),
                Core.getInstance().getBadHighlitedColor().getR(),
                Core.getInstance().getBadHighlitedColor().getG(),
                Core.getInstance().getBadHighlitedColor().getB(),
                1.0F
            ...
            item = layout.addItem();
            item.setLabel(
                Translator.getText("Tooltip_weapon_SpentRounds", new Object[0]) + ":",
                Core.getInstance().getBadHighlitedColor().getR(),
                Core.getInstance().getBadHighlitedColor().getG(),
                Core.getInstance().getBadHighlitedColor().getB(),
                1.0F
        ...
        if (!StringUtils.isNullOrEmpty(this.getMagazineType())) {
            if (this.isContainsClip()) {
                item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_weapon_ContainsClip", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            } else {
                item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_weapon_NoClip", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            }
        }

        for (int i = 0; i < this.attachmentList.size(); i++) {
            WeaponPart weaponPart = this.attachmentList.get(i);
            LayoutItem weaponPartLayoutItem = layout.addItem();
            weaponPartLayoutItem.setLabel(Translator.getText("Tooltip_weapon_" + weaponPart.getPartType(), new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.hasTag(ItemTag.NO_MAINTENANCE_XP)) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_NoMaintenanceXp", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
        }
    }

    public float getDamageMod(IsoGameCharacter chr) {
        int bluntLevel = chr.getPerkLevel(Perks.Blunt);
        ...
        int axeLevel = chr.getPerkLevel(Perks.Axe);
        ...
        int spearLevel = chr.getPerkLevel(Perks.Spear);
    ...
    public Perk getPerk() {
        if (this.weaponCategories.contains(WeaponCategory.AXE)) {
            ...
            return WeaponType.getWeaponType(this).isRanged() ? Perks.Aiming : Perks.Blunt;
        }
    }
    ...
    public float getMaxRange(IsoGameCharacter owner) {
        return this.isRanged() ? this.maxRange + this.getAimingPerkRangeModifier() * (owner.getPerkLevel(Perks.Aiming) / 2.0F) : this.maxRange;
    }
    ...
    public static boolean isAimedFirearm(HandWeapon handWeapon) {
        return handWeapon != null && handWeapon.isAimedFirearm() && !handWeapon.hasTag(ItemTag.FAKE_WEAPON);
    }
    ...
    public int getRecoilDelay(IsoGameCharacter owner) {
        return PZMath.max(
            ...
            (int)(
                this.recoilDelay
                    * (1.0F - owner.getPerkLevel(Perks.Aiming) / 40.0F)
                    * (1.0F - (-10.0F + owner.getPerkLevel(Perks.Strength) * 2.0F) / 40.0F)
    ...
    public float getMinSightRange(IsoGameCharacter character) {
        return (this.activeSight != null ? this.activeSight.getMinSightRange() : this.minSightRange) * (1.0F - character.getPerkLevel(Perks.Aiming) / 30.0F);
    }
    ...
    public float getMaxSightRange(IsoGameCharacter character) {
        return character.hasTrait(CharacterTrait.SHORT_SIGHTED) && !character.isWearingGlasses()
            ...
            : (this.activeSight != null ? this.activeSight.getMaxSightRange() : this.maxSightRange)
                * (1.0F + character.getPerkLevel(Perks.Aiming) / 30.0F)
    ...
    public boolean checkJam(IsoPlayer player, boolean racking) {
        ...
        boolean limp = !racking
            ...
            && (
                player.getPerkLevel(Perks.Aiming) < 3 && player.getPerkLevel(Perks.Strength) < 5
                    || player.getPerkLevel(Perks.Aiming) < 5 && player.getPerkLevel(Perks.Strength) < 3
            );
        ...
        DebugType.Combat.debugln("Jam chance: %f, roll: %f, jammed: %s", new Object[]{chance, roll, roll < chance});
        if (roll < chance) {
            this.setJammed(true);
        }
    ...
    public boolean checkUnJam(IsoPlayer player) {
        float modifier = 8.0F * ((float)this.getCondition() / this.getConditionMax());
        float chance = 8.0F
            - player.getPerkLevel(Perks.Aiming) * 0.5F
        ...
        float roll = Rand.Next(0.0F, 1.0F);
        DebugType.Combat.debugln("UnJam chance: %f, roll: %f, unjammed: %s", new Object[]{chance, roll, roll < chance});
        if (roll < chance) {
