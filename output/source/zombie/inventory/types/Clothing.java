...
public class Clothing extends InventoryItem {
    ...
    private int lastGasMaskSyncMinute = -1;
            ...
            if (this.container != null && this.container.parent instanceof IsoGameCharacter c) {
                ...
                if (drop && c.getSquare() != null && c.getVehicle() == null) {
                    if (GameServer.server) {
                        GameServer.sendRemoveItemFromContainer(c.getInventory(), this);
                    }

                    c.getInventory().Remove(this);
                    c.getSquare().AddWorldInventoryItem(this, Rand.Next(100) / 100, Rand.Next(100) / 100, 0.0F);
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, Layout layout) {
        ...
        if (!this.isCosmetic()) {
            ...
            item.setLabel(Translator.getText("Tooltip_weapon_Condition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            ...
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_item_Insulation", new Object[0]) + ": ", 1.0F, 1.0F, 0.8F, 1.0F);
            ...
            if (f > 0.0F) {
                item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_item_Windresist", new Object[0]) + ": ", 1.0F, 1.0F, 0.8F, 1.0F);
                Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), f, g2Bgrad);
                item.setProgress(f, g2Bgrad.getR(), g2Bgrad.getG(), g2Bgrad.getB(), 1.0F);
            }
            ...
            if (f > 0.0F) {
                item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_item_Waterresist", new Object[0]) + ": ", 1.0F, 1.0F, 0.8F, 1.0F);
                Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), f, g2Bgrad);
                item.setProgress(f, g2Bgrad.getR(), g2Bgrad.getG(), g2Bgrad.getB(), 1.0F);
            }
        }
        ...
        if (this.bloodLevel != 0.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_clothing_bloody", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            float f = this.bloodLevel / 100.0F;
        ...
        if (this.dirtyness >= 1.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_clothing_dirty", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            float f = this.dirtyness / 100.0F;
            Core.getInstance().getGoodHighlitedColor().interp(Core.getInstance().getBadHighlitedColor(), f, b2Ggrad);
            item.setProgress(f, b2Ggrad.getR(), b2Ggrad.getG(), b2Ggrad.getB(), 1.0F);
        }
        ...
        if (this.wetness != 0.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_clothing_wet", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            float f = this.wetness / 100.0F;
            Core.getInstance().getGoodHighlitedColor().interp(Core.getInstance().getBadHighlitedColor(), f, b2Ggrad);
            item.setProgress(f, b2Ggrad.getR(), b2Ggrad.getG(), b2Ggrad.getB(), 1.0F);
        }
        ...
        if (numHoles > 0) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_clothing_holes", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (!this.isEquipped() && tooltipUI.getCharacter() != null) {
            ...
            if (newBiteDefense != previousBiteDefense) {
                ...
                if (newBiteDefense > 0.0F || previousBiteDefense > 0.0F) {
                    item.setLabel(Translator.getText("Tooltip_BiteDefense", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                    if (newBiteDefense > previousBiteDefense) {
                        item.setValue(
            ...
            if (newScratchDefense != previousScratchDefense) {
                ...
                if (newScratchDefense > 0.0F || previousScratchDefense > 0.0F) {
                    item.setLabel(Translator.getText("Tooltip_ScratchDefense", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                    if (newScratchDefense > previousScratchDefense) {
                        item.setValue(
            ...
            if (newBulletDefense != previousBulletDefense) {
                ...
                if (newBulletDefense > 0.0F || previousBulletDefense > 0.0F) {
                    item.setLabel(Translator.getText("Tooltip_BulletDefense", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                    if (newBulletDefense > previousBulletDefense) {
                        item.setValue(
        ...
        if (this.hasTag(new ItemTag[]{ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK})) {
            if (this.hasFilter()) {
                String filterName = ScriptManager.instance.getItem(this.getFilterType()).getDisplayName();
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText(filterName, new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                ...
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_NoFilter", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            }
        ...
        if (this.hasTag(ItemTag.SCBA)) {
            if (this.hasTank()) {
                ...
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText(tankName, new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                ...
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_NoTank", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            }
        ...
        if (this.getRunSpeedModifier() != 1.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_RunSpeedModifier", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (this.getRunSpeedModifier() > 1.0F) {
        ...
        if (this.getCombatSpeedModifier() != 1.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_CombatSpeedModifier", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (this.getRunSpeedModifier() > 1.0F) {
    ...
    public String getName(IsoPlayer player) {
        String prefix = "";
        if (this.isDirty()) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Dirty", new Object[0]) + ", ";
        }

        if (this.isBloody()) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Bloody", new Object[0]) + ", ";
        }

        if (this.getWetness() >= 100.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Soaked", new Object[0]) + ", ";
        } else if (this.getWetness() > 25.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Wet", new Object[0]) + ", ";
        }

        if (this.isBroken()) {
            prefix = prefix + Translator.getText("Tooltip_Clothing_broken", new Object[0]) + ", ";
        } else if (this.getCondition() < this.getConditionMax() / 3.0F) {
            prefix = prefix + Translator.getText("IGUI_ClothingName_Worn", new Object[0]) + ", ";
        }
        ...
        if (this.getFluidContainer() != null) {
            ...
            return prefix.isEmpty() ? this.name : Translator.getText("IGUI_ClothingNaming", new Object[]{prefix, this.name});
        }
    }
    ...
    public void updateWetness(boolean bIgnoreEquipped) {
        if (bIgnoreEquipped || !this.isEquipped()) {
            if (this.getBloodClothingType() == null) {
                ...
                this.lastWetnessUpdate = GameTime.checkHours(this.lastWetnessUpdate, worldAgeHours);
    ...
    private Clothing.WetDryState getWetDryState() {
        if (this.getWorldItem() != null) {
            ...
            if (this.container.parent instanceof IsoDeadBody chr) {
            ...
            } else if (this.container.parent instanceof IsoGameCharacter chr) {
                ...
                if (!chr.isAsleep() && !chr.isResting()
                    || chr.getBed() == null
                    || !chr.getBed().isTent() && !"Tent".equalsIgnoreCase(chr.getBed().getName()) && !"Shelter".equalsIgnoreCase(chr.getBed().getName())) {
                    BaseVehicle vehicle = chr.getVehicle();
                    if (vehicle != null && vehicle.hasRoof(vehicle.getSeat(chr))) {
                ...
                IsoCombinationWasherDryer washerDryer = (IsoCombinationWasherDryer)Type.tryCastTo(this.container.parent, IsoCombinationWasherDryer.class);
    ...
    public void save(ByteBuffer output, boolean net) throws IOException {
        ...
        BitHeaderWrite bits = BitHeader.allocWrite(HeaderSize.Byte, output);
    ...
    public void load(ByteBuffer input, int worldVersion) throws IOException {
        ...
        BitHeaderRead bits = BitHeader.allocRead(HeaderSize.Byte, input);
        if (!bits.equals(0)) {
            if (bits.hasFlags(1)) {
    ...
    public static int getBiteDefenseFromItem(IsoGameCharacter chr, InventoryItem fabric) {
        int tailorLvl = Math.max(1, chr.getPerkLevel(Perks.Tailoring));
    ...
    public void removePatch(BloodBodyPartType part) {
        if (this.patches != null) {
            ...
            if (GameServer.server && this.getPlayer() instanceof IsoPlayer player && player.isEquippedClothing(this)) {
                INetworkPacket.sendToAll(PacketType.SyncClothing, new Object[]{player});
                INetworkPacket.sendToAll(PacketType.SyncVisuals, new Object[]{player});
            }
        }
    }
    ...
    public boolean canFullyRestore(IsoGameCharacter chr, BloodBodyPartType part, InventoryItem fabric) {
        return chr.getPerkLevel(Perks.Tailoring) > 7 && fabric.getFabricType().equals(this.getFabricType()) && this.getVisual().getHole(part) > 0.0F;
    }
    ...
    public void fullyRestore() {
        ...
        if (GameServer.server) {
            INetworkPacket.sendToAll(PacketType.SyncClothing, new Object[]{this.getOwner()});
        }
    }
    ...
    public void addPatch(IsoGameCharacter chr, BloodBodyPartType part, InventoryItem fabric) {
        ...
        if (this.canFullyRestore(chr, part, fabric)) {
            ...
            if (GameServer.server && chr instanceof IsoPlayer player && player.isEquippedClothing(this)) {
                INetworkPacket.sendToAll(PacketType.SyncClothing, new Object[]{chr});
                INetworkPacket.sendToAll(PacketType.SyncVisuals, new Object[]{chr});
            }
        }
    }
    ...
    public boolean hasFilter() {
        return this.hasTag(new ItemTag[]{ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK})
    ...
    public void setNoFilter() {
        if (this.hasTag(new ItemTag[]{ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK})) {
            ...
            if (this.is(new ItemKey[]{zombie.scripting.objects.ItemKey.Clothing.HAT_IMPROVISED_GAS_MASK})) {
                this.getModData().rawset("customInventoryIcon", "Item_GasMask_Crafted");
                this.syncItemFields();
            }
        }
    }
    ...
    public void setFilterType(String filterType) {
        ...
        if (this.is(new ItemKey[]{zombie.scripting.objects.ItemKey.Clothing.HAT_IMPROVISED_GAS_MASK})) {
            this.getModData().rawset("customInventoryIcon", "Item_GasMask_Crafted_Filtre");
            this.syncItemFields();
        }
    }
    ...
    public void setNoTank() {
        if (this.hasTag(ItemTag.SCBA)) {
            ...
            if (this.is(new ItemKey[]{zombie.scripting.objects.ItemKey.Clothing.SCBA})) {
                this.getModData().rawset("customInventoryIcon", "Item_SCBA");
                this.syncItemFields();
            }
        }
    }
    ...
    public void setTankType(String tankType) {
        ...
        if (this.is(new ItemKey[]{zombie.scripting.objects.ItemKey.Clothing.SCBA})) {
            this.getModData().rawset("customInventoryIcon", "Item_SCBA_Tank");
            this.syncItemFields();
        }
    }
    ...
    public String getAlternateModelName() {
        if (this.hasTag(new ItemTag[]{ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK})
            && !this.hasFilter()
            && !StringUtils.isNullOrWhitespace(this.getWithoutDrainable())) {
            Item withoutDrainableItem = ScriptManager.instance.getItem(this.getWithoutDrainable());
            if (withoutDrainableItem != null && withoutDrainableItem.getClothingItemAsset() != null) {
                return "WithoutDrainable";
            }
        }

        if (this.hasTag(ItemTag.SCBA) && !this.hasTank() && !StringUtils.isNullOrWhitespace(this.getWithoutDrainable())) {
            Item withoutDrainableItem = ScriptManager.instance.getItem(this.getWithoutDrainable());
            if (withoutDrainableItem != null && withoutDrainableItem.getClothingItemAsset() != null) {
                return "WithoutDrainable";
            }
        ...
        return super.getAlternateModelName();
    }
    ...
    public void drainGasMask(float rate) {
        if (this.hasTag(new ItemTag[]{ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK}) && this.hasFilter() && !(this.getUsedDelta() <= 0.0F)
            )
         {
            ...
            if (GameServer.server) {
                int currentMinute = GameTime.getInstance().getMinutes();
                if (currentMinute != this.lastGasMaskSyncMinute) {
                    this.syncItemFields();
                    this.lastGasMaskSyncMinute = currentMinute;
                }
            }
        }
    }
    ...
    public float getCorpseSicknessDefense() {
        ...
        if (this.hasFilter()) {
            float value = ZomboidGlobals.basicMaskDefense;
            if (this.getUsedDelta() > 0.0F) {
                value = this.hasTag(ItemTag.IMPROVISED_GAS_MASK) ? ZomboidGlobals.improvisedGasMaskDefense : ZomboidGlobals.standardGasMaskDefense;
            }
        ...
        if (this.hasFilter() && ZomboidGlobals.basicMaskDefense > defense) {
            defense = ZomboidGlobals.basicMaskDefense;
        }
    ...
    public static class ClothingPatch {
        ...
        public String getFabricTypeName() {
            return Translator.getText("IGUI_FabricType_" + this.fabricType, new Object[0]);
        }
    ...
    public enum ClothingPatchFabricType {
        ...
        ClothingPatchFabricType(final int index, final String type, final int maxScratchDef, final int maxBiteDef) {
            this.index = index;
            this.type = type;
