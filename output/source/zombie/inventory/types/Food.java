...
public final class Food extends InventoryItem {
    ...
    private static final ItemContainer floorContainer = new ItemContainer("floor", null, null);
            ...
            if (this.fertilizedTime >= this.timeToHatch) {
                ...
                if (inInv) {
                    ...
                    if (GameServer.server) {
                        GameServer.sendAddItemToContainer(this.getContainer(), animalInv);
                        GameServer.sendRemoveItemFromContainer(this.getContainer(), this);
                    }
    ...
    public void update() {
        ...
        if (outermostContainer != null) {
            ...
            } else if (this.isTainted && this.heat > 1.6F && !this.isFrozen()) {
                int currentCookMinute = GameTime.getInstance().getMinutes();
                if (currentCookMinute != this.lastCookMinute) {
                    this.lastCookMinute = currentCookMinute;
                    float dt = 1.0F;
    ...
    public void registerWithSoundLimiter(SoundInstanceLimiter limiter) {
        if (this.shouldPlayCookingSound()) {
            ...
            limiter.register(this, this.getSoundLimiterGroupID(), square.getX() + 0.5F, square.getY() + 0.5F, square.getZ());
        }
    }
    ...
    private void setCookingParameter(BaseSoundEmitter emitter) {
        ...
        if (cookingParam != this.cookingParameter) {
            ...
            emitter.setParameterValueByName(this.cookingSound, "CookingState", this.cookingParameter);
        }
    }
    ...
    private void updateTemperature() {
        this.temperatureTimeAccum = this.temperatureTimeAccum + this.timeMultiplier / 1.6F;
        if (!(this.temperatureTimeAccum < 10.0F)) {
            ...
            if (this.heat < temp) {
                this.heat = this.heat + temp / 1000.0F * this.temperatureTimeAccum;
            ...
            if (!GameClient.client) {
                if (this.replaceOnRotten != null && !this.replaceOnRotten.isEmpty()) {
                    ...
                    if (this.isRotten()) {
                        ...
                        if (newItem == null) {
                            DebugType.General.warn("ReplaceOnRotten = " + this.replaceOnRotten + " doesn't exist for " + this.getFullType());
    ...
    public void updateAge(boolean bSendItemStats) {
        ...
        if (elapsedHours > this.lastAged) {
            ...
            if (this.isFrozen()) {
                ageIncrease *= 0.0;
            } else if (this.isInFridge(outermostContainer) || this.isInFreezer(outermostContainer)) {
                if (outermostContainer.getSourceGrid() != null && outermostContainer.getSourceGrid().haveElectricity()) {
                    ...
                    float hoursWithElectricity = Math.min(SandboxOptions.instance.getElecShutModifier() * 24, elapsedHours);
    ...
    public void setAutoAge() {
        ...
        if (this.isInFridge(outermostContainer) || this.isInFreezer(outermostContainer)) {
            ...
            if (electShutModifier > -1) {
                float daysWithElectricity = Math.min(electShutModifier, worldAgeDays);
                if (!this.isInFridge(outermostContainer) && this.canBeFrozen()) {
    ...
    private void updateFreezing(ItemContainer outermostContainer, float worldAgeHours) {
        this.lastFrozenUpdate = GameTime.checkHours(this.lastFrozenUpdate, worldAgeHours);
        if (worldAgeHours > this.lastFrozenUpdate) {
            ...
            if (this.isThawing()) {
                ...
                if (this.isInFridge(outermostContainer) && outermostContainer.isPowered()) {
    ...
    public void save(ByteBuffer output, boolean net) throws IOException {
        ...
        BitHeaderWrite header = BitHeader.allocWrite(HeaderSize.Byte, output);
        ...
        BitHeaderWrite bits = BitHeader.allocWrite(HeaderSize.Integer, output);
        if (this.heat != 1.0F) {
            bits.addFlags(1);
    ...
    public void load(ByteBuffer input, int worldVersion) throws IOException {
        ...
        BitHeaderRead header = BitHeader.allocRead(HeaderSize.Byte, input);
        if (!header.equals(0)) {
            ...
            if (header.hasFlags(64)) {
                BitHeaderRead bits = BitHeader.allocRead(HeaderSize.Integer, input);
                if (bits.hasFlags(1)) {
        ...
        if (this.is(new ItemKey[]{zombie.scripting.objects.ItemKey.Food.CORPSE_ANIMAL})) {
            this.initAnimalIcons();
        }
    }
    ...
    public String getName(IsoPlayer player) {
        ...
        return foodPrefix.isEmpty() ? this.name : Translator.getText("IGUI_FoodNaming", new Object[]{foodPrefix, this.name});
    }
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, Layout layout) {
        ...
        if (this.getHungerChange() != 0.0F && !this.hasTag(ItemTag.HIDE_HUNGER_CHANGE)) {
            ...
            item.setLabel(Translator.getText("Tooltip_food_Hunger", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.getThirstChange() != 0.0F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Thirst", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.getEnduranceChange() != 0.0F) {
            ...
            item.setLabel(Translator.getText("Tooltip_food_Endurance", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (value > 0) {
        ...
        if (this.getStressChange() != 0.0F) {
            ...
            item.setLabel(Translator.getText("Tooltip_food_Stress", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (this.getStressChange() < 0.0F) {
        ...
        if (this.getBoredomChange() != 0.0F) {
            ...
            item.setLabel(Translator.getText("Tooltip_food_Boredom", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (value > 0.0F) {
                item.setProgress(value, goodR, goodG, goodB, 1.0F);
            } else {
                item.setProgress(value * -1.0F, badR, badG, badB, 1.0F);
        ...
        if (this.getUnhappyChange() != 0.0F) {
            ...
            item.setLabel(Translator.getText("Tooltip_food_Unhappiness", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            if (value > 0.0F) {
                item.setProgress(value, goodR, goodG, goodB, 1.0F);
            } else {
                item.setProgress(value * -1.0F, badR, badG, badB, 1.0F);
        ...
        if (this.isIsCookable() && !this.isFrozen() && !this.burnt && this.getHeat() > 1.6) {
            ...
            String s = Translator.getText("IGUI_invpanel_Cooking", new Object[0]);
            if (ct > mtc) {
                highlight = Core.getInstance().getBadHighlitedColor();
                s = Translator.getText("IGUI_invpanel_Burning", new Object[0]);
                tr = highlight.getR();
                tg = highlight.getG();
                tb = highlight.getB();
                f = (ct - mtc) / (mtb - mtc);
        ...
        if (this.getFreezingTime() < 100.0F && this.getFreezingTime() > 0.0F) {
            ...
            float tb = 0.8F;
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("IGUI_invpanel_FreezingTime", new Object[0]) + ": ", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (Core.debug && this.isFertilized()) {
            ...
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_fertilized", new Object[0]), 0.5F, 1.0F, 0.4F, 1.0F);
        }

        IsoGameCharacter character = tooltipUI.getCharacter();
        IsoPlayer player = (IsoPlayer)Type.tryCastTo(character, IsoPlayer.class);
        boolean proCook = character != null & character.getPerkLevel(Perks.Cooking) > 4;
        ...
        if (proCook && this.isIsCookable()) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_MinutesToCook", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if ((!Core.debug || !DebugOptions.instance.tooltipInfo.getValue())
            ...
            if (this.isPackaged() && illiterate) {
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_food_Nutrition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                item = layout.addItem();
                item.setLabel(Translator.getText("ContextMenu_Illiterate", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            } else if (this.isPackaged() && tooDark) {
                LayoutItem item = layout.addItem();
                item.setLabel(Translator.getText("Tooltip_food_Nutrition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
                item = layout.addItem();
                item.setLabel(Translator.getText("ContextMenu_TooDark", new Object[0]), 1.0F, 1.0F, 0.8F, 1.0F);
            }
        } else {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Nutrition", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Calories", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            item.setValueRightNoPlus(this.getCalories());
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Carbs", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            item.setValueRightNoPlus(this.getCarbohydrates());
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Prots", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            item.setValueRightNoPlus(this.getProteins());
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_Fat", new Object[0]) + ":", 1.0F, 1.0F, 0.8F, 1.0F);
        ...
        if (this.isbDangerousUncooked() && !this.isCooked() && !this.isBurnt()) {
            LayoutItem item = layout.addItem();
            item.setLabel(
                Translator.getText("Tooltip_food_Dangerous_uncooked", new Object[0]),
            ...
            if (this.hasTag(ItemTag.EGG)) {
                item.setLabel(Translator.getText("Tooltip_food_SlightDanger_uncooked", new Object[0]), 1.0F, 0.0F, 0.0F, 1.0F);
            }
        }
        ...
        if (this.getScriptItem().removeUnhappinessWhenCooked && !this.isCooked() && !this.isBurnt()) {
            LayoutItem item = layout.addItem();
            item.setLabel(
                Translator.getText("Tooltip_food_CookToRemoveUnhappiness", new Object[0]),
                Core.getInstance().getBadHighlitedColor().getR(),
                Core.getInstance().getBadHighlitedColor().getG(),
                Core.getInstance().getBadHighlitedColor().getB(),
                1.0F
        ...
        if ((this.isGoodHot() || this.isBadCold()) && this.heat < 1.3F) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_BetterHot", new Object[0]), 1.0F, 0.9F, 0.9F, 1.0F);
        }

        if (this.cookedInMicrowave) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_CookedInMicrowave", new Object[0]), 1.0F, 0.9F, 0.9F, 1.0F);
        }

        if (!StringUtils.isNullOrEmpty(this.getMilkType())) {
            LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_food_MilkType", new Object[0]) + ": ", 1.0F, 0.9F, 0.9F, 1.0F);
            item.setValue(Translator.getText("Tooltip_food_" + this.getMilkType(), new Object[0]), 1.0F, 0.9F, 0.9F, 1.0F);
        }
    ...
    public boolean isFreezing() {
        ItemContainer outermostContainer = this.getOutermostContainer();
        return this.canBeFrozen() && !(this.getFreezingTime() >= 100.0F) && this.isInFreezer(outermostContainer) ? outermostContainer.isPowered() : false;
    }
    ...
    public boolean isThawing() {
        ...
        if (!this.canBeFrozen() || this.getFreezingTime() <= 0.0F) {
            ...
            return !this.isInFreezer(outermostContainer) ? true : !outermostContainer.isPowered();
        }
    }
    ...
    public void setCurrentUses(int newuses) {
        ...
        if (this.getBaseHunger() == 0.0F) {
            ...
            this.consumeHunger((this.getCurrentUses() - newuses) / 100.0F);
        }
    }
    ...
    public void syncItemFields() {
        super.syncItemFields();
        ItemContainer outer = this.getOutermostContainer();
        if (outer != null) {
            if (outer.getParent() instanceof IsoPlayer player) {
                if (GameClient.client) {
                    INetworkPacket.send(PacketType.ItemStats, new Object[]{this.getContainer(), this});
                } else if (GameServer.server) {
                    INetworkPacket.send(player, PacketType.ItemStats, new Object[]{this.getContainer(), this});
                }
            } else if (this.getContainer().getSquare() != null) {
                IsoGridSquare sq = this.getContainer().getSquare();
                INetworkPacket.sendToRelative(PacketType.ItemStats, sq.getX(), sq.getY(), new Object[]{this.getContainer(), this});
            }
        } else {
            if (GameClient.client) {
                INetworkPacket.send(PacketType.ItemStats, new Object[]{this.getContainer(), this});
    ...
    private void syncItemFieldForWorldItem() {
        this.syncItemFields();
        if (GameServer.server && this.getWorldItem() != null) {
            floorContainer.setSourceGrid(this.getWorldItem().getSquare());
            INetworkPacket.sendToRelative(PacketType.ItemStats, this.getWorldItem().getX(), this.getWorldItem().getY(), new Object[]{floorContainer, this});
        }
    }
    ...
    public void copyFrozenFrom(Food otherFood) {
        if (this.canBeFrozen()) {
            ...
            this.setFrozen(otherFood.isFrozen());
        }
    }
    ...
    public void copyNutritionFromRatio(Food otherFood, float ratio) {
        ...
        this.setBoredomChange(otherFood.getBoredomChange() * ratio);
    }
    ...
    public void copyExtraItems(Food otherFood) {
        ...
        if (otherFood.getSpices() != null && !otherFood.getSpices().isEmpty()) {
            this.setSpices(otherFood.getSpices());
        }
    }
    ...
    private boolean isInFridge(ItemContainer itemContainer) {
        return itemContainer != null && itemContainer.isFridge();
    }

    private boolean isInFreezer(ItemContainer itemContainer) {
        return itemContainer != null && itemContainer.isFreezer();
    }
    ...
    private void initAnimalIcons() {
        ...
        if (corpse != null && corpse.isAnimal()) {
            ...
            if (def != null) {
                ...
                if (breed != null) {
                    boolean isBaby = def.isBaby();
                    String icon;
                    if (corpse.isSkeleton()) {
                        if (isBaby) {
                            icon = breed.invIconBabySkel;
                        } else {
                            icon = corpse.isFemale() ? breed.invIconFemaleSkel : breed.invIconMaleSkel;
                        }
                    } else if (isBaby) {
                        icon = breed.invIconBabyDead;
                    } else {
                        icon = corpse.isFemale() ? breed.invIconFemaleDead : breed.invIconMaleDead;
                    }

                    if (icon != null) {
                        Texture texture = Texture.getSharedTexture(icon);
                        if (texture != null) {
                            this.setTexture(texture);
                            this.setTexturerotten(texture);
                        }

                        Texture textureRotten = Texture.getSharedTexture(icon + "Rotten");
                        if (textureRotten != null) {
                            this.setTexturerotten(textureRotten);
                        }
                    }
                }
            }
