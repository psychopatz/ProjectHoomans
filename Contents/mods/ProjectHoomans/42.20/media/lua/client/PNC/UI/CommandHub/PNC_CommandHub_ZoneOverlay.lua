...
function Overlay.Render()
    if not Overlay.zone or not addAreaHighlightForPlayer then return end
    ...
    elseif Overlay.activeDefinitionID == "corpse_haul" then
        renderRegion(playerNum, Overlay.zone.sourceRegion,
            CORPSE_SOURCE_COLOR)
        renderRegion(playerNum, Overlay.zone.destinationRegion,
