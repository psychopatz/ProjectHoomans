-- Client bridge lifecycle facade for PBrainZ.
--
...
require "PNC/Integrations/PBrainZ/PNC_PBrainZ_BridgeSettings"
require "PNC/Integrations/PBrainZ/PNC_PBrainZ_BridgeRegistration"
...
local function registerBridge()
    ...
    if registered then
        log(
            "bridge_registered",
            "namespace=pbrainz.llm commands=pollChat,deliverChat"
