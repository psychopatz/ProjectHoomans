...
StartingTraits.DEFINITIONS = {
    ...
    { id = T.IS_MARRIED, resource = "pnc:pnc_ismarried", cost = 2,
        relationshipKind = "lover", sex = "orientation", sharesSurname = true,
        uiName = "UI_PNC_Trait_IsMarried",
        uiDescription = "UI_PNC_Trait_IsMarried_Description" },
