...
Config.MOBILE_SETTLEMENT_VISIT_HOURS = 12
Config.MOBILE_SETTLEMENT_VISIT_INTERVAL_HOURS = 1
Config.MOBILE_SETTLEMENT_AI_JOIN_CHANCE = 0.35
...
Config.UNIQUE_NPC_POOL_CHANCE = 0.005
Config.UNIQUE_NPC_MAX_PER_GENERATION = 1
