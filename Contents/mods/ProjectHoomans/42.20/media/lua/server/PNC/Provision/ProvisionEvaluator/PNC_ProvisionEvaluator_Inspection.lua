...
function Evaluator.Inspect(record)
    ...
    for _, definition in ipairs(Registry.List()) do
        ...
        local rule = {
            ...
            available = evaluation and evaluation.available or 0,
            incoming = evaluation and evaluation.incoming or 0,
            incomingProjected = evaluation
                and evaluation.incomingProjected or 0,
            refillBelow = evaluation and evaluation.refillBelow or 0,
            target = evaluation and evaluation.target or 0,
            policyTarget = evaluation and evaluation.policyTarget or 0,
            stateAware = evaluation and evaluation.stateAware == true,
            currentNeed = evaluation and evaluation.currentNeed,
            needTarget = evaluation and evaluation.needTarget,
