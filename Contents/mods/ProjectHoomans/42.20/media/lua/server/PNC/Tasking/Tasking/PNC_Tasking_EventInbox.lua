...
Events.Types = Events.Types or {
    ...
    MEDICAL_CARE_REQUESTED = "MEDICAL_CARE_REQUESTED",
    MEDICAL_CARE_REQUEST_CHANGED = "MEDICAL_CARE_REQUEST_CHANGED",
    MEDICAL_CARE_PHASE_CHANGED = "MEDICAL_CARE_PHASE_CHANGED",
    MEDICAL_CARE_COMPLETED = "MEDICAL_CARE_COMPLETED",
    MEDICAL_CARE_CANCELLED = "MEDICAL_CARE_CANCELLED",
    TASK_REEVALUATION_FAILED = "TASK_REEVALUATION_FAILED",
    TASK_CANCELLATION_COMPLETED = "TASK_CANCELLATION_COMPLETED",
