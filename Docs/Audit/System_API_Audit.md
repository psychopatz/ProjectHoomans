...
|---|---|---|---|---|
| `ARC-933CD01F76` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | API.DebugCommand spans 223 lines. |

### Large modules and functions

| Kind | ID | Tokens | File | Symbol |
|---|---|---:|---|---|
| Large function | `ARC-933CD01F76` | 223 | Contents/mods/ProjectHoomans/42.20/media/lua/shared/PNC/Core/API/PNC_API.lua:368 | API.DebugCommand |
