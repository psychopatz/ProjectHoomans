...
Large serialize/deserialize functions. Split schema normalization, codecs, migrations, and commit orchestration; treat save compatibility and nil/default handling as contracts.
...
|---|---|---|---|---|
| `ARC-3338E6F69A` | `LARGE_MODULE` | MEDIUM | HIGH (92%) | Contents/mods/ProjectHoomans/42.20/media/lua/shared/PNC/Core/Persistence/PNC_Persistence.lua has 1056 code lines; review responsibility density. |
| `ARC-9F040D8B4A` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | Persistence.DeserializeRecord spans 235 lines. |
| `ARC-CEAC5AC714` | `LARGE_FUNCTION` | MEDIUM | HIGH (90%) | Persistence.SerializeRecord spans 157 lines. |

### Large modules and functions

| Kind | ID | Tokens | File | Symbol |
|---|---|---:|---|---|
| Large module | `ARC-3338E6F69A` | 1056 | Contents/mods/ProjectHoomans/42.20/media/lua/shared/PNC/Core/Persistence/PNC_Persistence.lua | — |
| Large function | `ARC-9F040D8B4A` | 235 | Contents/mods/ProjectHoomans/42.20/media/lua/shared/PNC/Core/Persistence/PNC_Persistence.lua:820 | Persistence.DeserializeRecord |
